...
| DBの種類　| 総塩基数 |
|---|---|
| 国際塩基配列DB | 2.1×10<sup>12</sup> (2.1 T) |
| 次世代シークエンサーからの塩基配列DB(公開分)  |  4.5×10<sup>15</sup> (4.5 P) |
| ヒトリファレンスゲノム配列 | 3.1×10<sup>9</sup> (3.1 G) |
---
### 1.2 バイオテクノロジーとデータ解析の歴史
- 配列解読手法の発明   4
- 配列データベースの誕生   6
...
| 1965 | アミノ酸配列データベースが誕生 |
| 1970 | アミノ酸配列を大域的に比較する方法が登場 |
...
| 年 | 出来事 |
|---|---|
| 1981〜 | DNA 配列を局所的に比較する方法が開発される |
| 1988 | FASTAの登場により配列DBの迅速な検索が可能になる |
| 1990 | より高速な BLAST が NCBI により開発される |
...
### 次世代シークエンサーの誕生
- NGS の登場
- NGS の配列を処理するツールやDBが゙生み出される
- 長い配列が読めるシークエンサーが登場する
---
### 日本のデータベース統合化の動き
